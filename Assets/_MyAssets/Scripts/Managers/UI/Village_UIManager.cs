...
public class Village_UIManager : MonoBehaviour
{
    public static Village_UIManager Instance { get; private set; }
    ...
    private void Update()
    {
        ...
        {            
            if(_options.activeSelf || _commandes.activeSelf)
                FermerTout();
            else
                ToggleMenu();            
        }
    ...
    {        
        _menuPrincipal.SetActive(!_menuPrincipal.activeSelf);
